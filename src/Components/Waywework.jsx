    ...
    <div className="mb-3">
      <div className="row">
        <div className="col-4 d-flex align-items-center">
            <img src="https://www.interiorcompany.com/_next/image?url=%2Fassets%2Fimages%2Fwe-work-web.webp&w=1080&q=75"/>
        </div>
        <div className="col-7 px-4">
          <div className="d-flex flex-column">
            <h6 className="text-center">The Way We Work</h6>
            <p  className="text-center mb-lg-4 mb-3">Five steps is all it takes to elevate your style of living.</p>
            <Steppers  />
